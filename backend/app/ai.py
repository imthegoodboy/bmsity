...
def evaluate_submission_with_openai(
    *,
    ...
    prompt = (
        ...
        "Do not write placeholder phrases such as 'no distinct answer visible' into answer_text; "
        "when no student answer is visible, keep answer_text empty and attempted false. "
